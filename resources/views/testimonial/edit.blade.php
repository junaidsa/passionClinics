                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name_ar" name="name_ar" value="{{$testimonial->name_ar}}" placeholder="أدخل الاسم" dir="rtl" />
                                    @error('name_ar')
                                        <div class=" invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('designation_ar') is-invalid @enderror"
                                        id="designation_ar" name="designation_ar" value="{{$testimonial->designation_ar}}" placeholder="أدخل التعيين" dir="rtl" />
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="message" class="form-label float-end">رسالة (Arabic)</label>
                                        ...
                                        name="message_ar" rows="5" placeholder="رسالة" dir="rtl">{{$testimonial->message_ar}}</textarea>
                                    @error('message_ar')
                                        <div class=" invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
